"""Exactly-once handoff layer: an idempotency ledger keyed on the natural key
of a unit of work.
...
This module is concept-agnostic: it knows nothing about clocks, filings,
or any specific domain. It is the exactly-once core any Band agent can reuse.
"""
